...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 14 17:13:59 2021
...
class Tester():
    ...
    def test_model(self):
        ...
        #with open('static/dashboard_data/results.csv', 'w') as csv_file:
            ...
            #for a, h, t in zip(test_agg, testing_history, test_target):
              #  csv_writer.writerow((i, a, h[0], t))
              #  i += 1
...
def plot_results():
        #path for the saved results csv 
    ...
    plt.plot(df['mains'], label="Mains")
    plt.plot(df['microwave'][:- (2 * offset_microwave)], label="Microwave")
    plt.plot(df['dishwasher'][:- (2 * offset_dishwasher)], label="Dishwasher")
...
if __name__ == '__main__':
    ...
    #You need to give the path of the test file here (csv file)
    test_directory = '/Users/shalinimustala/Documents/PPDS_coursework/DSCI560/Energy_disaggregation/seq2point-nilm/saved_best/test_mains.csv'
    #test_directory_dishwasher = 
    ...
    parser.add_argument("--network_type", type=remove_space, default="seq2point", help="The seq2point architecture to use. Only use if you do not want to use the standard architecture. Available are: default, dropout, reduced, and reduced_dropout. ")
    ...
    saved_model_microwave =  '/Users/shalinimustala/Documents/PPDS_coursework/DSCI560/Energy_disaggregation/seq2point-nilm/saved_best/microwave_best_e2w11.h5'
    saved_model_dishwasher = '/Users/shalinimustala/Documents/PPDS_coursework/DSCI560/Energy_disaggregation/seq2point-nilm/saved_best/dishwasher_best_e5w199b500.h5'
    path = os.getcwd()

    # The logs including results will be recorded to this log file
    #it automatically takes the path based on current directory ---> no need to change this!
    log_file_dir = os.path.join(path, arguments.appliance_name + "_" + arguments.algorithm + "_" + arguments.network_type + ".log")
    ...
    plot_results()
    #the mains data, appliance ground truth and appliance predicted data are stored as json in these variables
    #you can use these jsons for dashboard
